...
class CPDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        warped_cloth_mask = transforms.Resize(self.crop_size,
                                              interpolation=transforms.InterpolationMode.NEAREST)(warped_cloth_mask)
...
class CPDatasetV2(CPDataset):
    ...
    def __getitem__(self, index):
        ...
        # load captions
        caption_name = osp.join(self.data_path, "cloth", c_name[key]).replace("cloth",
        ...
        ignore_mask, ignore_masks_ = self.create_ignore_mask(inpaint_mask)
        result = {
            "GT": im,
            # "inpaint_image": inpaint_warp_cloth,
            "inpaint_image": im * inpaint_mask,
    ...
    def create_ignore_mask(self, mask):
        ...
        return ignore_mask, ignore_mask_
